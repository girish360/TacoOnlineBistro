...
AS
BEGIN
INSERT INTO Orders(OrderId,UserId,TotalAmount,DeliveryAdress,Comments,DeliveryStatus,DateOfOrder)
VALUES(@OrderId,@UserId,@TotalAmount,@DeliveryAdress,@Comments,@DeliveryStatus,@DateOfOrder)
END
GO
