...
INSERT INTO Orders([OrderId],[UserId],[TotalAmount],[DeliveryAdress],[Comments],[DeliveryStatus],[OrderDate]) VALUES ('16641A4B-01C6-4F19-8FE1-D7086AD1DC65','ED1851F7-C233-482A-B4E5-6B59B6CC884D',37.9,'Plopilor nr. 5 scare 3 ap.55','the address is right besides the buss station',0,GETDATE());
INSERT INTO Orders([OrderId],[UserId],[TotalAmount],[DeliveryAdress],[Comments],[DeliveryStatus],[OrderDate]) VALUES ('99D7B6FF-C816-4577-990F-C59304C6BEA2','ED1851F7-C233-482A-B4E5-6B59B6CC884D',44.9,'Plopilor nr. 5 scara 3 ap.55','Please hurry up',0,GETDATE());
INSERT INTO Orders([OrderId],[UserId],[TotalAmount],[DeliveryAdress],[Comments],[DeliveryStatus],[OrderDate]) VALUES ('D975D889-A702-4855-B3EC-D8F2B08F5626','6A852880-8D89-4B02-901A-24996B4B7E17',45.0,'strada Brancusi nr 190,scara 5 ap. 55','Hi the block is right in front of the buss station',1,GETDATE());
INSERT INTO Orders([OrderId],[UserId],[TotalAmount],[DeliveryAdress],[Comments],[DeliveryStatus],[OrderDate]) VALUES ('1D911A5F-E5AA-4C90-853F-1EAEC4614FA8','56B8BEAB-845B-46B7-9D62-2AB2174BEE5B',68.9,'Strada Actorului nr.15','The big house with a red fense',1,GETDATE());
